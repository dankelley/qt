...
if 4 != len(sys.argv):
    ...
    print("  python " + sys.argv[0] +  " 1 /dev/tty.usbmodem1421 /Users/kelley/qt/database/qt.db")
    print("i.e. station_code=1, device=/dev/tty.usbmodem1421, database=/Users/kelley/qt/database/qt.db")
    exit(2)
